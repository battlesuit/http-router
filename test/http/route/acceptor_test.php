...
class AcceptorTest extends TestCase {
  ...
  function test_default_acception_success() {
    $this->assert_true_acception(new Object(), new Request('get', 'http://example.de'));
  }
  
  function test_default_acception_failure() {
    $this->assert_false_acception(new Object(), new Request('delete', 'http://example.de'));
  }
  
  function test_method_acception() {
    $this->assert_true_acception(new Object('delete'), new Request('delete', 'http://example.de'));
  }
  ...
  function test_root_pattern_acception_with_domain_path_url() {
    $this->assert_true_acception(new Object('post', '/foo/bar'), new Request('post', 'http://example.de/foo/bar'));
  }
  
  function test_root_pattern_acception_with_path_info_url() {
    $this->assert_true_acception(new Object('post', '/foo/bar'), new Request('post', 'http://example.de/file.php/foo/bar'));
  }
  
  function test_glob_acception_without_param_name() { 
    $this->assert_true_acception(new Object('get', '/foo*'), new Request('get', 'http://example.de/file.php/foo/bar/hello_a/asd-dad'));
  }
